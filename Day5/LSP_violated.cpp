...
public:
    ...
    void processTransactions(){
        ...
        for(Account* acc: accounts){
            ...
            // Assuming all account support withdrawl (LSP violation)
            // For safety purpose we have applied try catch block but in real life client ko kaha pta hota hai ye sabh
            try{
                acc->withdraw(500);
