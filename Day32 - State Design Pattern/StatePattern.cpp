...
// Abstract State interference
class VendingState{
public:
// return the reference of the Vending state
...
private:
    ...
    // All concrete Vending state reference
...
// Constructor of the VendingMachine
VendingMachine::VendingMachine(int itemCount, int itemPrice){
    
    // 20 water bottles each of price 30 
