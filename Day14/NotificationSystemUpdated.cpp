...
public:
    Logger() {
        // notifcationService ka getInstance call krte hai and then we call getObservable ki mil jaaye
        // observable mil gya and observable kai list mai khud ko bhi dal diya
       this->notificationObservable = NotificationService::getInstance()->getObservable();
    //    khud ka instance pass kr diya , logger ka instance pass kr diya 
    // logger also an observer
...
int main() {
    ...
    // client just need to make notificationService 
    ...
    // client will know ki konse konse strategy hai jiska use kr skta hi wo
...
// Now application has become plug and play
// notfication ko bhejna is part of observable design pattern